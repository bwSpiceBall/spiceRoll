        ...
        <div className="flex flex-1">
            <main className="flex flex-1 flex-col items-center p-8">
                <p className="max-w-2xl text-center text-lg leading-relaxed">
                    ...
                    environment. I’m dedicated to creating well-documented,
                    thoroughly tested code and actively collaborate with
                    cross-functional teams to deliver reliable and impactful
                    software that supports evolving business needs.
                </p>
            </main>
        </div>
    ) 
